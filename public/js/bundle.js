    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 8:
          ...
          (0, _alerts.showAlert)('error', "Error in logging out ".concat(_context2.t0.message, "!!"));
        case 12:
        case "end":
  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(data, type) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          url = type === 'data' ? 'http://localhost:3000/v1/users/updateme' : 'http://localhost:3000/v1/auth/updatepassword';
          _context.next = 4;
          return (0, _axios.default)({
            method: 'PATCH',
            url: url,
